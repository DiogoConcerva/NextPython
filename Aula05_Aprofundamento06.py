...
# embaralhados. Por exemplo: se função receber a palavra python, pode retornar npthyo, ophtyn ou
# qualquer outra combinação possível, de forma aleatória. Padronize em sua função que todos os
